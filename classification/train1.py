...
parser.add_argument('--log_path', default='/content/drive/MyDrive/project/QC_cow1/classification/log', type=str)  # 로그 텍스트를 저장할 위치
...
# make folders
if not os.path.exists('/content/drive/MyDrive/project/QC_cow1/classification/log'):
    os.mkdir('/content/drive/MyDrive/project/QC_cow1/classification/log')
    
if not os.path.exists('/content/drive/MyDrive/project/QC_cow1/classification/model_weight'):
    os.mkdir('/content/drive/MyDrive/project/QC_cow1/classification/model_weight')
    
if not os.path.exists('/content/drive/MyDrive/project/QC_cow1/classification/checkpoint'):
    os.mkdir('/content/drive/MyDrive/project/QC_cow1/classification/checkpoint')
...
def main_worker(args):    
    ...
    base_root= '/content/drive/MyDrive/project_files/New_sample/Dataset/preprocessed/classification/'
...
def save_checkpoint(state, is_best, is_best_acc, is_best_f1, filename='/content/drive/MyDrive/project/QC_cow1/classification/checkpoint/'+args.model_name+'_'+args.exp+'.pht'):
    torch.save(state, filename)
    if is_best_acc:
        shutil.copyfile(filename, '/content/drive/MyDrive/project/QC_cow1/classification/model_weight/'+args.model_name+'_'+args.exp+'_best_Acc.pth')
    
    if is_best:
        shutil.copyfile(filename, '/content/drive/MyDrive/project/QC_cow1/classification/model_weight/'+args.model_name+'_'+args.exp+'_best_Loss.pth')
        
    if is_best_f1:
        shutil.copyfile(filename, '/content/drive/MyDrive/project/QC_cow1/classification/model_weight/'+args.model_name+'_'+args.exp+'_best_F1.pth')
